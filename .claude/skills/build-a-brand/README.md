...
This skill has a sister at `~/.claude/skills/business-maker/` that does the same brand-building work PLUS commerce setup (Shopify, product listings, social launch). Use build-a-brand when the deliverable is just the brand; use business-maker when the deliverable is a full launch.
